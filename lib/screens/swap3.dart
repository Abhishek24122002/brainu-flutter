...
class swap3 extends StatefulWidget {
  @override
  _swap3State createState() => _swap3State();
}

class _swap3State extends State<swap3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(S.of(context).spoonerism_question, style: TextStyle(color: Colors.white)),
